...
class TermsAndConditionsController extends CrudController
{
    /**
     ...
     */
    public function __construct(protected TermsAndConditionsRepository $repository,
    ...
    public function store(Request $request): Redirector|RedirectResponse|Application
    {
        ...
        try {
            ...
            $requestData['file'] = $this->repository->creteMultiMediaFiles($request, static::getSnakeName());
