...
@section('title', 'Отзыва о товарах')
...
@section('content')
    ...
    <form method="GET" action="{{ url('/admin/reviews') }}" accept-charset="UTF-8"
        ...
        <table class="table">
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td>{{ $item->course->getName->$lang }}</td>
                    ...
                    <td>
                        <a href="{{ url('/admin/reviews/' . $item->id . '/edit') }}" title="Редактировать отзыв">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"
                                                                      aria-hidden="true"></i> Редактировать
                            </button>
                        </a>

                        <form method="POST" action="{{ url('/admin/reviews/' . $item->id) }}"
