...
@section('content')
    ...
    <a href="{{ url('/admin/pages/create') }}" class="btn btn-success btn-sm" title="Добавить">
        ...
        <table class="table">
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td>{{ $item->slug }}</td>
                    <td>@if($item->menu) Активен @else Не активен @endif</td>
                    <td>@if($item->is_active) Активен @else Не активен @endif</td>
                    <td>
                        <a href="{{ url('/admin/page-items/page/' . $item->id) }}" title="Edit">
                            <button class="btn btn-secondary btn-sm">
                                <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Значение
                            </button>
                        </a>

                        <a href="{{ url('/admin/pages/' . $item->id . '/edit') }}" title="Edit">
