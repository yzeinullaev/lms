...
@section('content')
    ...
    <form method="POST" action="{{ url('/admin/banks/' . $data->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
        {{ method_field('PATCH') }}
        {{ csrf_field() }}

        @include ('admin.banks.form', ['formMode' => 'edit'])
