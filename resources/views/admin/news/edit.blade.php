...
@section('content_header')
    <h1>Редактировать новость: категория {{ $parentData->getName->$lang }}</h1>
@stop
...
@section('content')
    ...
    <form method="POST" action="{{ url('/admin/news/' . $data->id) }}" accept-charset="UTF-8" class="form-horizontal"
