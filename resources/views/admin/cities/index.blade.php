...
@section('content')
    ...
    <form method="GET" action="{{ url('/admin/cities') }}" accept-charset="UTF-8"
        ...
        <table class="table">
            ...
            @foreach($data as $item)
                <tr>
                    ...
                    <td>
                        <a href="{{ url('/admin/cities/' . $item->id . '/edit') }}" title="Edit city">
                            <button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o"
                                                                      aria-hidden="true"></i> Редактировать
                            </button>
                        </a>

                        <form method="POST" action="{{ url('/admin/cities' . '/' . $item->id) }}" accept-charset="UTF-8"
